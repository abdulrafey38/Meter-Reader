...
<head>
    ...
    <style type="text/css">
        body {
            background-image:url("https://strawberryspirit.com/wp-content/uploads/2018/04/light-bulb-3104355.jpg");
...
<div class="login-form">
    <h2 class="text-center col" >Admin Login</h2>
    <form method="post" action="{{route('login')}}" class="text-left ">
        ...
        <p class="hint-text">Visit => <a href="">Reading</a></p>
...
<div class="form-footer">
    <p style="color:white"; >Meter Reading ©2016-2020</p>
</div>
<!--//footer-->
